...
var ProductStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("found error while index model ".concat(err_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("found error while show model ".concat(error_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    ProductStore.prototype.create = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, newProduct, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("found error while create Product model ".concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
