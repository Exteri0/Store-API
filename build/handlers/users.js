            ...
            switch (_a.label) {
                case 0:
                    try {
                        ...
                        res.status(401).json("Access denied, Invalud token. ".concat(err));
                        return [2 /*return*/];
                    }
                    _a.label = 1;
                case 1:
                ...
                case 3:
                    err_1 = _a.sent();
                    res.status(500).json("internetal server error, ".concat(err_1));
                    return [3 /*break*/, 4];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_3 = _a.sent();
                    res.status(500).json("error while users create handler ".concat(err_3));
                    return [3 /*break*/, 3];
